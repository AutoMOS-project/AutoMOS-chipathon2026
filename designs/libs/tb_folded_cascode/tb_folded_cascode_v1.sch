...
N -80 -150 -80 -110 {lab=0}
N -80 -270 -80 -210 {lab=vn}
...
C {vsource.sym} -240 -180 0 0 {name=V2 value="dc 1.65 ac 0.5 0" savecurrent=false}
...
C {vsource.sym} -80 -180 0 0 {name=V6 value="dc 1.65 ac 0.5 180" savecurrent=false}
C {gnd.sym} -80 -110 0 0 {name=l7 lab=0}
C {lab_pin.sym} -80 -270 0 0 {name=p15 sig_type=std_logic lab=vn}
