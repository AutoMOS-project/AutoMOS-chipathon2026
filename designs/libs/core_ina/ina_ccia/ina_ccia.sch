...
N 1770 -1750 1950 -1750 {lab=#net4}
N 1220 -1300 1280 -1300 {lab=CLKb}
N 1000 -1240 1040 -1240 {lab=#net5}
...
N 1560 -1300 1640 -1300 {lab=#net6}
N 1380 -1210 2180 -1210 {lab=VSS}
N 1840 -1050 1880 -1050 {lab=#net7}
N 1880 -1330 1880 -1050 {lab=#net7}
N 1840 -1030 1920 -1030 {lab=#net8}
N 1920 -1310 1920 -1030 {lab=#net8}
N 1380 -1420 2180 -1420 {lab=VDD}
N 1740 -950 1740 -930 {lab=VSS}
N 1840 -1010 1900 -1010 {lab=Vcm}
N 1840 -990 1900 -990 {lab=Vb}
N 2280 -1310 2320 -1310 {lab=#net4}
N 2320 -1680 2320 -1310 {lab=#net4}
N 2280 -1290 2320 -1290 {lab=#net9}
N 1040 -1340 1040 -690 {lab=#net10}
N 2320 -1410 2380 -1410 {lab=Voutp}
N 2320 -1190 2380 -1190 {lab=Voutn}
N 1840 -1330 1880 -1330 {lab=#net7}
N 1840 -1310 1920 -1310 {lab=#net8}
N 1920 -1310 2080 -1310 {lab=#net8}
N 1880 -1330 2080 -1330 {lab=#net7}
...
N 2320 -1290 2320 -690 {lab=#net9}
N 1560 -1300 1560 -1020 {lab=#net6}
N 1560 -1020 1640 -1020 {lab=#net6}
N 1750 -640 1750 -600 {lab=Vg}
N 1750 -1630 1750 -1590 {lab=Vg}
N 1550 -1750 1550 -1680 {lab=#net3}
N 1950 -1750 1950 -1680 {lab=#net4}
N 1550 -760 1710 -760 {lab=#net10}
N 1770 -760 1950 -760 {lab=#net9}
N 1550 -760 1550 -690 {lab=#net10}
N 1890 -1680 1950 -1680 {lab=#net4}
N 1950 -1680 2320 -1680 {lab=#net4}
N 1950 -690 2320 -690 {lab=#net9}
N 1950 -760 1950 -690 {lab=#net9}
N 1890 -690 1950 -690 {lab=#net9}
N 1550 -690 1610 -690 {lab=#net10}
...
C {symbols/cap_mim_2f0fF.sym} 1740 -760 3 0 {name=C4
W=10e-6
L=10e-6
model=cap_mim_2f0fF
spiceprefix=X
...
C {opin.sym} 2380 -1410 0 0 {name=p17 lab=Voutp}
C {opin.sym} 2380 -1190 0 0 {name=p18 lab=Voutn}
