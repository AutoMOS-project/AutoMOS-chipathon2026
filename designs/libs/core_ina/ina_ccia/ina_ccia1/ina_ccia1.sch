...
N 1410 -1420 1410 -1400 {lab=VDD}
N 2210 -1420 2210 -1370 {lab=VDD}
N 1770 -1420 1770 -1390 {lab=VDD}
N 2210 -1230 2210 -1210 {lab=VSS}
N 1770 -1250 1770 -1210 {lab=VSS}
N 1410 -1260 1410 -1210 {lab=VSS}
N 1770 -1110 1770 -1090 {lab=VDD}
N 1630 -1110 1770 -1110 {lab=VDD}
N 1630 -1380 1630 -1110 {lab=VDD}
...
C {libs/core_ina/ina_cmfb/ina_cmfb.sym} 1770 -1020 0 1 {name=x2}
C {libs/core_ina/ina_chopper/ina_chopper.sym} 1410 -1330 0 0 {name=x3}
C {libs/core_ina/ina_chopper/ina_chopper.sym} 2210 -1300 0 0 {name=x4}
...
C {ipin.sym} 1350 -1420 0 0 {name=p11 lab=VDD}
...
C {libs/core_ina/ina_ota/ina_ota.sym} 1770 -1320 0 0 {name=x1}
...
spiceprefix=X
m=5}
C {libs/core_ina/ina_pseudores/ina_pseudores.sym} 1780 -1680 0 0 {name=x5}
C {libs/core_ina/ina_pseudores/ina_pseudores.sym} 1780 -690 0 0 {name=x6}
