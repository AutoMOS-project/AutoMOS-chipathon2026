...
N 1380 -1420 1380 -1400 {lab=VDD3V3}
N 2180 -1420 2180 -1370 {lab=VDD3V3}
N 1740 -1420 1740 -1390 {lab=VDD3V3}
N 2180 -1230 2180 -1210 {lab=VSS}
N 1740 -1250 1740 -1210 {lab=VSS}
N 1380 -1260 1380 -1210 {lab=VSS}
N 1740 -1110 1740 -1090 {lab=VDD3V3}
N 1600 -1110 1740 -1110 {lab=VDD3V3}
N 1600 -1380 1600 -1110 {lab=VDD3V3}
...
N 1380 -1420 2180 -1420 {lab=VDD3V3}
...
N 1600 -1420 1600 -1380 {lab=VDD3V3}
...
N 1320 -1420 1380 -1420 {lab=VDD3V3}
...
C {/foss/designs/core_ina/ina_cmfb.sym} 1740 -1020 0 1 {name=x2}
C {/foss/designs/core_ina/ina_chopper.sym} 1380 -1330 0 0 {name=x3}
C {/foss/designs/core_ina/ina_chopper.sym} 2180 -1300 0 0 {name=x4}
...
C {ipin.sym} 1320 -1420 0 0 {name=p11 lab=VDD3V3}
...
C {/foss/designs/core_ina/ina_ota.sym} 1740 -1320 0 0 {name=x1}
...
spiceprefix=X
m=5}
C {/foss/designs/core_ina/ina_pseudores.sym} 1750 -690 0 0 {name=x6}
C {/foss/designs/core_ina/ina_pseudores.sym} 1750 -1680 0 0 {name=x5}
