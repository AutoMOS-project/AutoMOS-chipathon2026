...
N 1410 -1710 1410 -1670 {lab=VDD3V3}
N 2360 -1150 2360 -1110 {lab=VDD3V3}
N 2020 -1150 2020 -1110 {lab=VDD3V3}
N 1740 -1150 1740 -1110 {lab=VDD3V3}
N 1740 -1710 1740 -1630 {lab=VDD3V3}
N 2020 -1710 2020 -1630 {lab=VDD3V3}
...
N 1330 -1710 2360 -1710 {lab=VDD3V3}
N 1330 -910 2360 -910 {lab=VSS}
N 2480 -1570 2560 -1570 {lab=CLKA}
N 2360 -1710 2360 -1630 {lab=VDD3V3}
...
C {/foss/designs/core_ina/ina_nand.sym} 1420 -1570 0 0 {name=x1}
C {/foss/designs/core_ina/ina_nand.sym} 1420 -1050 0 0 {name=x2}
C {/foss/designs/core_ina/ina_inv.sym} 1060 -1310 1 0 {name=x3}
C {/foss/designs/core_ina/ina_inv.sym} 1740 -1570 0 0 {name=x4}
C {/foss/designs/core_ina/ina_inv.sym} 2020 -1570 0 0 {name=x5}
C {/foss/designs/core_ina/ina_inv.sym} 2360 -1570 0 0 {name=x6}
C {/foss/designs/core_ina/ina_inv.sym} 1740 -1050 0 0 {name=x7}
C {/foss/designs/core_ina/ina_inv.sym} 2020 -1050 0 0 {name=x8}
C {/foss/designs/core_ina/ina_inv.sym} 2360 -1050 0 0 {name=x9}
...
C {lab_wire.sym} 1160 -1310 0 1 {name=p2 sig_type=std_logic lab=VDD3V3}
C {lab_wire.sym} 1410 -1190 0 1 {name=p4 sig_type=std_logic lab=VDD3V3}
C {lab_wire.sym} 2360 -1470 0 1 {name=p5 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 2360 -1150 0 1 {name=p8 sig_type=std_logic lab=VDD3V3}
C {lab_wire.sym} 2020 -1150 0 1 {name=p9 sig_type=std_logic lab=VDD3V3}
C {lab_wire.sym} 1740 -1150 0 1 {name=p10 sig_type=std_logic lab=VDD3V3}
...
C {ipin.sym} 1330 -1710 0 0 {name=p7 lab=VDD3V3}
